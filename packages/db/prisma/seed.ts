...
// --- Mock dataset (ported from apps/web/lib/data.ts) -----------------------
...
const companies: Company[] = [
  {
    ...
    financials: { revenueUsd: 410_000_000, revenueGrowthPct: 62, grossMarginPct: 74, burnMonths: 38 },
    rounds: [
      { name: 'Seed', date: '2016-09-01', amountUsd: 3_200_000, postMoneyUsd: 14_000_000, lead: 'Founders Collective', investors: [{ name: 'Founders Collective', lead: true }, { name: 'Liquid 2 Ventures', lead: false }] },
      { name: 'Series A', date: '2018-03-12', amountUsd: 22_000_000, postMoneyUsd: 120_000_000, lead: 'Index Ventures', investors: [{ name: 'Index Ventures', lead: true }, { name: 'Founders Collective', lead: false }] },
      { name: 'Series B', date: '2019-11-04', amountUsd: 75_000_000, postMoneyUsd: 600_000_000, lead: 'Sequoia Capital', investors: [{ name: 'Sequoia Capital', lead: true }, { name: 'Index Ventures', lead: false }, { name: 'Stripe', lead: false }] },
      { name: 'Series C', date: '2021-05-20', amountUsd: 230_000_000, postMoneyUsd: 4_100_000_000, lead: 'Tiger Global', investors: [{ name: 'Tiger Global', lead: true }, { name: 'Sequoia Capital', lead: false }, { name: 'Coatue', lead: false }] },
      { name: 'Series D', date: '2022-10-18', amountUsd: 420_000_000, postMoneyUsd: 12_500_000_000, lead: 'Founders Fund', investors: [{ name: 'Founders Fund', lead: true }, { name: 'Tiger Global', lead: false }, { name: 'GIC', lead: false }] },
      { name: 'Series E', date: '2024-06-11', amountUsd: 600_000_000, postMoneyUsd: 24_000_000_000, lead: 'Thrive Capital', investors: [{ name: 'Thrive Capital', lead: true }, { name: 'Founders Fund', lead: false }, { name: 'GIC', lead: false }, { name: 'Sequoia Capital', lead: false }] },
    ],
    people: [
      { name: 'Mara Okonkwo', role: 'Co-founder & CEO', since: 2016, prior: 'Square', title: 'Chief Executive Officer', linkedinUrl: 'https://www.linkedin.com/in/mara-okonkwo' },
      { name: 'Devin Aluko', role: 'Co-founder & CTO', since: 2016, prior: 'Stripe', title: 'Chief Technology Officer', linkedinUrl: 'https://www.linkedin.com/in/devin-aluko' },
    ...
    investors: [
      { name: 'Sequoia Capital', type: 'Venture', firstRound: 'Series B', rounds: 3, websiteUrl: 'https://www.sequoiacap.com', linkedinUrl: 'https://www.linkedin.com/company/sequoia' },
      { name: 'Index Ventures', type: 'Venture', firstRound: 'Series A', rounds: 2, websiteUrl: 'https://www.indexventures.com', linkedinUrl: 'https://www.linkedin.com/company/index-ventures' },
    ...
    acquisitions: [
      { target: 'Ledgerline', date: '2022-02-09', amountUsd: 48_000_000, rationale: 'Double-entry reconciliation engine, folded into core ledger.' },
      { target: 'Cardinal KYC', date: '2023-08-22', amountUsd: null, rationale: 'Identity verification team and model, undisclosed terms.' },
    ],
    exits: [],
    diversity: [
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/vellum',
    operatingStatus: 'Active',
    companyType: 'For profit',
    ...
    exits: [
      { type: 'Acquisition', date: '2023-09-15', valueUsd: 20_000_000_000, detail: 'Acquired by Northwind Software (deal later terminated by regulators).' },
    ],
    diversity: [{ label: 'Founder representation', value: 'Mixed', note: 'Two-person founding team.' }],
  },
  {
    slug: 'sable-labs',
    name: 'Sable Labs',
    ...
    linkedinUrl: 'https://www.linkedin.com/company/sable-labs',
    operatingStatus: 'Active',
    companyType: 'For profit',
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/gridpoint',
    operatingStatus: 'Active',
    companyType: 'For profit',
    primarySector: 'Artificial intelligence',
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/meridian',
    operatingStatus: 'Active',
    companyType: 'For profit',
    primarySector: 'Fintech',
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/quill',
    operatingStatus: 'Active',
    companyType: 'For profit',
    primarySector: 'Enterprise SaaS',
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/palette',
    operatingStatus: 'Active',
    companyType: 'For profit',
    primarySector: 'Enterprise SaaS',
  ...
  },
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/company/beacon-hr',
    operatingStatus: 'Active',
    companyType: 'For profit',
    primarySector: 'Enterprise SaaS',
...
async function main() {
  // Idempotent: wipe domain data (cascades clear children) and re-seed.
  ...
  for (const c of companies) {
    await prisma.company.create({
      data: {
        ...
        operatingStatus: c.operatingStatus ?? null,
        ...
        status: c.status,
        stage: c.stage,
        totalRaisedUsd: BigInt(c.totalRaisedUsd),
        lastValuationUsd: money(c.lastValuationUsd),
        revenueUsd: money(c.financials?.revenueUsd ?? null),
        revenueGrowthPct: c.financials?.revenueGrowthPct ?? null,
        grossMarginPct: c.financials?.grossMarginPct ?? null,
        burnMonths: c.financials?.burnMonths ?? null,
        ...
        rounds: {
          create: (c.rounds ?? []).map((r) => ({
            ...
            amountUsd: BigInt(r.amountUsd),
            postMoneyUsd: money(r.postMoneyUsd),
            lead: r.lead,
            moderationStatus: 'APPROVED',
            submittedById: admin.id,
            investors: { create: r.investors.map((i) => ({ name: i.name, lead: i.lead })) },
          })),
        },
        people: {
          create: (c.people ?? []).map((p) => ({
            name: p.name,
            role: p.role,
            since: p.since,
            prior: p.prior,
        ...
        acquisitions: {
          create: (c.acquisitions ?? []).map((a) => ({
            target: a.target,
            date: new Date(a.date),
            amountUsd: money(a.amountUsd),
        ...
        exits: {
          create: (c.exits ?? []).map((e) => ({
            type: e.type,
            date: new Date(e.date),
            valueUsd: money(e.valueUsd),
            detail: e.detail,
            moderationStatus: 'APPROVED',
            submittedById: admin.id,
          })),
  ...
  await prisma.marketStat.createMany({
    data: marketStats.map((s) => ({
      sector: s.sector,
      dealCount: s.dealCount,
      totalRaisedUsd: BigInt(s.totalRaisedUsd),
      medianValuationUsd: BigInt(s.medianValuationUsd),
      trendPct: s.trendPct,
    })),
  });
  ...
  await prisma.marketSnapshot.create({
    data: {
      totalRaisedUsd: BigInt(marketTotals.totalRaisedUsd),
      dealCount: marketTotals.dealCount,
      newUnicorns: marketTotals.newUnicorns,
      quarter: marketTotals.quarter,
    },
  });

  console.log(`Seeded ${companies.length} companies, ${marketStats.length} market stats.`);
}
